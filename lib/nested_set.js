                            ...
                            if (nodes.every(function (node) {
                                ...
                                async.series([
                                    function (cb) {
                                        ...
                                        self.constructor.updateMany(conditions, {$inc: {lft: 2}}, cb);
                                    },
                                    function (cb) {
                                        let conditions = updateConditions({rgt: {$gt: maxRgt}}, self);
                                        self.constructor.updateMany(conditions, {$inc: {rgt: 2}}, cb);
                                    }
                                ], function (err, result) {
                                    self.lft = maxRgt + 1;
                                    self.rgt = maxRgt + 2;
